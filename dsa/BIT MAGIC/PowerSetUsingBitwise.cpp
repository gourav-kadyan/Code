...
using namespace std;
//ques is make all possible value of substring
/*
    logic is
    1.we make counter
    like string is "ab"
    2.counter  = 0 to 2 ^n -1
    3.after using nested loop we chk counter & 1 << j != 0
      thats it
    dry run of given ex is  
    counter                 value
    0 0 0                   ""
    0 0 1                   "a"
    0 1 0                   "b"
