...
using namespace std;
//josephus problem means that n no. of people standing in 
// circular way starting position/index from zero to n-1
// so in this every k-1 positioned person need to kill and 
// who is survivor
// complexity is T(n) =T(n-1)+c
// means theta n
// logic is simple just derement n by 1
// and  add k due to chng pistol position
//after we face an a issue is the return value is greater than the n 
// so we add modular n to every recursive call and gives the correct ans
